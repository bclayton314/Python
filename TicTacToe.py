...
def check_rows():
    ...
    #Check if any of the rows have all the same value and not equal to "-"
...
def check_columns():
  #Set up global variable
    global game_still_going
    #Check if any of the columns have all the same value and not equal to "-"
...
def check_diagonals():
  #Set up global variable
    global game_still_going
    #Check if any of the diagonals have all the same value and not equal to "-"
